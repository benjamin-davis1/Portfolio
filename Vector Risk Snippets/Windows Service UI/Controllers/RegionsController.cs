...
namespace FFDCServiceUI.Controllers
{
    public class RegionsController : Controller
    {
        ...
        public RegionsController(FFDCServiceUIContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,EndPoint")] Region region)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,EndPoint")] Region region)
        {
            if (id != region.ID)
            {
                return NotFound();
